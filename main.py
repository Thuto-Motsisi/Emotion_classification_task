...
if st.session_state.page == "consent":
    ...
    **Purpose:** You are being asked to participate in a research study to annotate Setswana sentences with emotion labels. 
    Your contributions will help improve Setswana emotion recognition models.
...
if st.session_state.page == "annotate":
    ...
    if st.session_state.page == "complete":
        ...
        st.subheader("Your Labeling Summary")
